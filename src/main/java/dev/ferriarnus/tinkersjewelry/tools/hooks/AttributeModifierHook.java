...
public interface AttributeModifierHook {
    Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack, ModifierEntry modifier);
    ...
    record AllMerger(Collection<AttributeModifierHook> modules) implements AttributeModifierHook {
        ...
        public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack, ModifierEntry modifier) {
            ...
            for (var module : modules) {
                multimap.putAll(module.getAttributeModifiers(slotContext, uuid, stack, modifier));
            }
            return multimap;
        }
    }
