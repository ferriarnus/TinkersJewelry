...
public class ArsenalToolStats {
	...
	public static final FloatToolStat AMPLIFICATION = ToolStats.register(new FloatToolStat(new ToolStatId(TinkersArsenal.MODID, "amplification"), 0xbd41a2, 1, 0.1f, 3));
